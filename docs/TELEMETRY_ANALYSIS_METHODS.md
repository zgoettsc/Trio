<!--
  Source of truth for this content lives in:
    Trio/Sources/Services/AlgorithmTelemetry/AlgorithmTelemetryDocs.swift

  Edit there and re-init the telemetry branch to update what new users get.
  This copy is a convenience for browsing in source.
-->
